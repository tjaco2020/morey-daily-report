          ...
          {rows.map((r) => (
            ...
            >
              <input
                ...
                className="flex-1 min-w-0 px-2 py-1 rounded-md border border-transparent hover:border-slate-200 focus:border-morey-yellow focus:bg-morey-yellowSoft focus:outline-none text-sm"
              />
              <select
                value={r.location_id ?? ""}
                onChange={(e) =>
                ...
                className="px-2 py-1 rounded-md border border-slate-200 hover:border-slate-300 text-xs bg-white max-w-[160px]"
              >
                <option value="">No location</option>
                {locations.map((l) => (
                  <option key={l.id} value={l.id}>
